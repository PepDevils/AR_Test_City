...
public class LocationHelper {
    ...
    // um pouco de teorica para perceber os seguintes algoritmos
    //      https://en.wikipedia.org/wiki/Geographic_coordinate_system
    //      http://digext6.defence.gov.au/dspace/bitstream/1947/3538/1/DSTO-TN-0432.pdf

    //todo: o smartphone tem de ter o sensor de compasso, como bloquear o download da loja caso este não o tenha?
